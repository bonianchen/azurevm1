...
scp -i CRED.pem CRED.pem azureuser@${IPA1}:/home/azureuser
scp -i CRED.pem azurevm1/westus3_provision.sh azureuser@${IPA1}:/home/azureuser
ssh -i CRED.pem azureuser@${IPA1} "scp -i CRED.pem westus3_provision.sh azureuser@${IPD2}:/home/azureuser; ssh -i CRED.pem azureuser@${IPD2} westus3_provision.sh"
